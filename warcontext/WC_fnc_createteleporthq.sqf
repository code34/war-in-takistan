	...
	wcteleport setvehicleinit "this allowdammage false; this setfuel 0; wcobject = this addAction ['Teleport to base', 'warcontext\WC_fnc_returntobase.sqf',[],-1,false]; wcplayerbox = this addAction ['Drop an Ammobox', 'warcontext\WC_fnc_docreateammobox.sqf',[],-1,false]; wcobject2 = this addAction ['Build a vehicle', 'warcontext\WC_fnc_vehicles.sqf',[],-1,false]; ";
	processInitCommands;
