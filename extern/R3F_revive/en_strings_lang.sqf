...
STR_R3F_REV_btn_reapparition = "Respawn at Base";
STR_R3F_REV_reapparition_camp_en_cours = "Respawn at Base in progress...";

STR_R3F_REV_attente_reanimation = "You're waiting for a medic...";
STR_R3F_REV_marqueur_attente_reanimation = "%1 unconscious";

STR_R3F_REV_nb_reanimations_plusieurs = "You've been revived...\nYou still have %1 possibilities of revive.";
STR_R3F_REV_nb_reanimations_une = "You've been revived...\nYou only have one possibility of revive.";
STR_R3F_REV_nb_reanimations_zero = "You've been revived...\nIt was your last possibility of revive.";

STR_R3F_REV_plus_de_reanimation = "You've reached the limit of revive...";
STR_R3F_REV_hors_jeu = "You're now out of the game...";
STR_R3F_REV_respawn_camp = "You respawn at Base...";

STR_R3F_REV_ne_pas_se_reanimer_soi_meme = "You can't revive yourself.";