...
class R3F_ARTY_dlg_clic_carte
{
	...
	onLoad = "execVM ""extern\R3F_ARTY_AND_LOG\R3F_ARTY\dlg_chef_batterie\traduire_dlg_clic_carte.sqf"";";
	...
	class R3F_ARTY_dlg_clic_carte_carte
	{
		...
		scaleDefault = 0.1;
		onMouseButtonClick = "_this execVM ""extern\R3F_ARTY_AND_LOG\R3F_ARTY\dlg_chef_batterie\clic_carte.sqf"";";
