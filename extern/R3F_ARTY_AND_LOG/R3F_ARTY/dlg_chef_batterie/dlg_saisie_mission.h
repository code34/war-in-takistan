...
class R3F_ARTY_dlg_saisie_mission
{
	...
	onLoad = "execVM ""extern\R3F_ARTY_AND_LOG\R3F_ARTY\dlg_chef_batterie\preremplir_dlg_saisie_mission.sqf"";";
	onUnload = "call compile preprocessFile ""extern\R3F_ARTY_AND_LOG\R3F_ARTY\dlg_chef_batterie\memoriser_dlg_saisie_mission.sqf"";";
	movingEnable = false;
	...
	class R3F_ARTY_dlg_SM_bord_haut : R3F_ARTY_dlg_SM_texte_basique
	{
		...
		text = "extern\R3F_ARTY_AND_LOG\R3F_ARTY\images\bord_haut.paa";
	};
	...
	class R3F_ARTY_dlg_SM_bord_gauche : R3F_ARTY_dlg_SM_texte_basique
	{
		...
		colorText[] = {1,1,1,1};
		colorBackground[] = {0,0,0,0};
		text = "extern\R3F_ARTY_AND_LOG\R3F_ARTY\images\bord_gauche.paa";
	};
	...
	class R3F_ARTY_dlg_SM_bord_droit : R3F_ARTY_dlg_SM_texte_basique
	{
		...
		colorText[] = {1,1,1,1};
		colorBackground[] = {0,0,0,0};
		text = "extern\R3F_ARTY_AND_LOG\R3F_ARTY\images\bord_droit.paa";
	};
	...
	class R3F_ARTY_dlg_SM_bord_bas : R3F_ARTY_dlg_SM_texte_basique
	{
		...
		colorText[] = {1,1,1,1};
		colorBackground[] = {0,0,0,0};
		text = "extern\R3F_ARTY_AND_LOG\R3F_ARTY\images\bord_bas.paa";
	};
	...
	class R3F_ARTY_dlg_SM_coin_haut_gauche : R3F_ARTY_dlg_SM_texte_basique
	{
		...
		colorText[] = {1,1,1,1};
		colorBackground[] = {0,0,0,0};
		text = "extern\R3F_ARTY_AND_LOG\R3F_ARTY\images\coin_haut_gauche.paa";
	};
	...
	class R3F_ARTY_dlg_SM_coin_haut_droit : R3F_ARTY_dlg_SM_texte_basique
	{
		...
		colorText[] = {1,1,1,1};
		colorBackground[] = {0,0,0,0};
		text = "extern\R3F_ARTY_AND_LOG\R3F_ARTY\images\coin_haut_droit.paa";
	};
	...
	class R3F_ARTY_dlg_SM_coin_bas_gauche : R3F_ARTY_dlg_SM_texte_basique
	{
		...
		colorText[] = {1,1,1,1};
		colorBackground[] = {0,0,0,0};
		text = "extern\R3F_ARTY_AND_LOG\R3F_ARTY\images\coin_bas_gauche.paa";
	};
	...
	class R3F_ARTY_dlg_SM_coin_bas_droit : R3F_ARTY_dlg_SM_texte_basique
	{
		...
		colorText[] = {1,1,1,1};
		colorBackground[] = {0,0,0,0};
		text = "extern\R3F_ARTY_AND_LOG\R3F_ARTY\images\coin_bas_droit.paa";
	};
	...
	class R3F_ARTY_dlg_SM_btn_fonctions : R3F_ARTY_dlg_SM_texte_basique
	{
		...
		colorText[] = {1,1,1,1};
		colorBackground[] = {0,0,0,0};
		text = "extern\R3F_ARTY_AND_LOG\R3F_ARTY\images\btn_fonctions.paa";
	};
	...
	class R3F_ARTY_dlg_SM_btn_generaux : R3F_ARTY_dlg_SM_texte_basique
	{
		...
		colorText[] = {1,1,1,1};
		colorBackground[] = {0,0,0,0};
		text = "extern\R3F_ARTY_AND_LOG\R3F_ARTY\images\btn_generaux.paa";
	};
	...
	class R3F_ARTY_dlg_SM_btn_power : R3F_ARTY_dlg_SM_texte_basique
	{
		...
		colorText[] = {1,1,1,1};
		colorBackground[] = {0,0,0,0};
		text = "extern\R3F_ARTY_AND_LOG\R3F_ARTY\images\btn_power.paa";
	};
	...
	class R3F_ARTY_dlg_SM_position_batterie_btn_pos_joueur : R3F_ARTY_dlg_SM_bouton_basique
	{
		...
		w = 0.1;
		text = "";
		action = "if (R3F_ARTY_CFG_autoriser_pos_joueur) then {execVM ""extern\R3F_ARTY_AND_LOG\R3F_ARTY\dlg_chef_batterie\pos_joueur.sqf"";} else {player globalChat STR_R3F_ARTY_fonction_interdite;};"; 
	};
	...
	class R3F_ARTY_dlg_SM_btn_calculer : R3F_ARTY_dlg_SM_bouton_basique
	{
		...
		sizeEx = 0.035;
		text = "";
		action = "execVM ""extern\R3F_ARTY_AND_LOG\R3F_ARTY\dlg_chef_batterie\calculer_solution_tir.sqf"";"; 
	};
	...
	class R3F_ARTY_dlg_SM_btn_ordonner_tir_courbe : R3F_ARTY_dlg_SM_bouton_basique
	{
		...
		sizeEx = 0.035;
		text = "";
		action = "[""courbe""] execVM ""extern\R3F_ARTY_AND_LOG\R3F_ARTY\dlg_chef_batterie\ordonner_tir.sqf"";"; 
	};
	...
	class R3F_ARTY_dlg_SM_btn_ordonner_tir_tendu : R3F_ARTY_dlg_SM_bouton_basique
	{
		...
		sizeEx = 0.035;
		text = "";
		action = "[""tendu""] execVM ""extern\R3F_ARTY_AND_LOG\R3F_ARTY\dlg_chef_batterie\ordonner_tir.sqf"";"; 
	};
