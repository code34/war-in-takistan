...
_piece addEventHandler ["GetIn",
{
	if (_this select 2 == player) then
	{
		_this spawn
		{
			...
			execVM "extern\R3F_ARTY_AND_LOG\R3F_ARTY\dlg_artilleur\afficher_dlg_artilleur.sqf";
		};
	};
}];
...
//_piece addAction [("<t color=""#22ee22"">" + STR_R3F_ARTY_action_ordre_suivant + "</t>"), "extern\R3F_ARTY_AND_LOG\R3F_ARTY\dlg_artilleur\ordre_suivant.sqf", nil, 6, false, true, "", "gunner _target == player"];
_piece addAction [("<t color=""#22ee22"">" + STR_R3F_ARTY_action_ouvrir_dlg_artilleur + "</t>"), "extern\R3F_ARTY_AND_LOG\R3F_ARTY\dlg_artilleur\afficher_dlg_artilleur.sqf", nil, 6, false, true, "", "gunner _target == player && (isNil ""R3F_ARTY_dlg_artilleur_ouverte"")"];
_piece addAction [("<t color=""#22ee22"">" + STR_R3F_ARTY_action_fermer_dlg_artilleur + "</t>"), "extern\R3F_ARTY_AND_LOG\R3F_ARTY\dlg_artilleur\fermer_dlg_artilleur.sqf", nil, 0, false, true, "", "gunner _target == player && (!isNil ""R3F_ARTY_dlg_artilleur_ouverte"")"];
_piece addAction [("<t color=""#22ee22"">" + STR_R3F_ARTY_action_purger_ordres+ "</t>"), "extern\R3F_ARTY_AND_LOG\R3F_ARTY\dlg_artilleur\purger_ordres.sqf", nil, 6, false, true, "", "gunner _target == player"];

// On ajoute une action de rechargement pour chaque type de munition compatible
{
	_piece addAction [("<t color=""#aa0000"">" + STR_R3F_ARTY_action_recharger_piece + (_x select 1) + "</t>"), "extern\R3F_ARTY_AND_LOG\R3F_ARTY\piece\recharger_piece.sqf", [_piece, _x], 0, false, true, "", "gunner _target == player"];
