...
_calculateur addAction [("<t color=""#dddd00"">" + STR_R3F_ARTY_action_ouvrir_dlg_SM + "</t>"), "extern\R3F_ARTY_AND_LOG\R3F_ARTY\poste_commandement\ouvrir_dlg_saisie_mission.sqf", nil, 6, true, true, "", "vehicle player == player && ((isNil ""R3F_LOG_active"") || ( isNull R3F_LOG_joueur_deplace_objet && isNull (_target getVariable ""R3F_LOG_est_deplace_par"") || (!alive (_target getVariable ""R3F_LOG_est_deplace_par"")) && isNull (_target getVariable ""R3F_LOG_est_transporte_par"") )) && (_target getVariable ""R3F_ARTY_est_calculateur"")"];
_calculateur addAction [("<t color=""#dddd00"">" + STR_R3F_ARTY_action_demonter_poste + "</t>"), "extern\R3F_ARTY_AND_LOG\R3F_ARTY\poste_commandement\deplacer_calculateur.sqf", nil, 5, true, true, "", "vehicle player == player && isNull R3F_LOG_joueur_deplace_objet && (isNull (_target getVariable ""R3F_LOG_est_deplace_par"") || (!alive (_target getVariable ""R3F_LOG_est_deplace_par""))) && isNull (_target getVariable ""R3F_LOG_est_transporte_par"") && (_target getVariable ""R3F_ARTY_est_calculateur"") && ((_target getVariable ""R3F_ARTY_demontable"") && !(isNil ""R3F_LOG_active""))"];