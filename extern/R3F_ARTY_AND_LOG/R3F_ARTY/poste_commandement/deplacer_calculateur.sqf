...
else
{
	...
	if (!alive player) then
	{
		...
		execVM "extern\R3F_ARTY_AND_LOG\R3F_ARTY\poste_commandement\installer_poste.sqf";
	...
	else
	{
		...
		_action_menu = player addAction [("<t color=""#dddd00"">" + STR_R3F_ARTY_action_installer_poste + "</t>"), "extern\R3F_ARTY_AND_LOG\R3F_ARTY\poste_commandement\installer_poste.sqf", nil, 5, true, true];
