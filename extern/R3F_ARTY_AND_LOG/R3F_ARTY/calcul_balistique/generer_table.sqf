 ...
 * One you generate the table, save it in a text file in the directory "extern\R3F_ARTY_AND_LOG\R3F_ARTY\tables\".
 * Then add an include line in the variable "R3F_ARTY_CFG_tables" in the file "extern\R3F_ARTY_AND_LOG\R3F_ARTY\config.sqf".
 ...
 * Une fois que vous avez générer la table, enregistrez là dans un fichier texte dans le répertoire "extern\R3F_ARTY_AND_LOG\R3F_ARTY\tables\".
 * Ensuite ajoutez une ligne d'inclusion dans la variable "R3F_ARTY_CFG_tables" du fichier "extern\R3F_ARTY_AND_LOG\R3F_ARTY\config.sqf".
 ...
 * ] call compile preprocessFile "extern\R3F_ARTY_AND_LOG\R3F_ARTY\calcul_balistique\generer_table.sqf";
 * 
 * 
