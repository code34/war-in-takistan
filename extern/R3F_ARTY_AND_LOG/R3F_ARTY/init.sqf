...
if !(isServer && isDedicated) then
{
	...
	R3F_ARTY_FNCT_calculer_portee = compile preprocessFile "extern\R3F_ARTY_AND_LOG\R3F_ARTY\calcul_balistique\calculer_portee.sqf";
	R3F_ARTY_FNCT_calculer_elevation = compile preprocessFile "extern\R3F_ARTY_AND_LOG\R3F_ARTY\calcul_balistique\calculer_elevation.sqf";
	R3F_ARTY_FNCT_tirer_position_dans_zone_elliptique = compile preprocessFile "extern\R3F_ARTY_AND_LOG\R3F_ARTY\fonctions_generales\tirer_position_dans_zone_elliptique.sqf";
	R3F_ARTY_FNCT_formater_deux_decimales = compile preprocessFile "extern\R3F_ARTY_AND_LOG\R3F_ARTY\fonctions_generales\formater_deux_decimales.sqf";
	R3F_ARTY_FNCT_formater_pos2D_vers_posGPS = compile preprocessFile "extern\R3F_ARTY_AND_LOG\R3F_ARTY\fonctions_generales\formater_pos2D_vers_posGPS.sqf";
	R3F_ARTY_FNCT_afficher_ordre = compile preprocessFile "extern\R3F_ARTY_AND_LOG\R3F_ARTY\dlg_artilleur\afficher_ordre.sqf";
	R3F_ARTY_FNCT_ordre_suivant = compile preprocessFile "extern\R3F_ARTY_AND_LOG\R3F_ARTY\dlg_artilleur\ordre_suivant.sqf";
	R3F_ARTY_FNCT_afficher_chargeur = compile preprocessFile "extern\R3F_ARTY_AND_LOG\R3F_ARTY\dlg_artilleur\afficher_chargeur.sqf";
	R3F_ARTY_FNCT_piece_init = compile preprocessFile "extern\R3F_ARTY_AND_LOG\R3F_ARTY\piece\piece_init.sqf";
	R3F_ARTY_FNCT_calculateur_init = compile preprocessFile "extern\R3F_ARTY_AND_LOG\R3F_ARTY\poste_commandement\calculateur_init.sqf";
...
{
	R3F_ARTY_FNCT_piece_init_dedie = compile preprocessFile "extern\R3F_ARTY_AND_LOG\R3F_ARTY\piece\piece_init_dedie.sqf";
};

if (isServer) then
{
	R3F_ARTY_FNCT_creer_poste_commandement = compile preprocessFile "extern\R3F_ARTY_AND_LOG\R3F_ARTY\poste_commandement\creer_poste_commandement.sqf";
	R3F_ARTY_FNCT_supprimer_poste_commandement = compile preprocessFile "extern\R3F_ARTY_AND_LOG\R3F_ARTY\poste_commandement\supprimer_poste_commandement.sqf";
...
R3F_ARTY_FNCT_get_chargeur_actuel = compile preprocessFile "extern\R3F_ARTY_AND_LOG\R3F_ARTY\piece\get_chargeur_actuel.sqf";
R3F_ARTY_FNCT_chargeurs_sont_egaux = compile preprocessFile "extern\R3F_ARTY_AND_LOG\R3F_ARTY\piece\chargeurs_sont_egaux.sqf";
R3F_ARTY_FNCT_get_chargeurs_compatibles_piece = compile preprocessFile "extern\R3F_ARTY_AND_LOG\R3F_ARTY\piece\get_chargeurs_compatibles_piece.sqf";
R3F_ARTY_FNCT_EH_fired_piece = compile preprocessFile "extern\R3F_ARTY_AND_LOG\R3F_ARTY\piece\EH_fired_piece.sqf";
R3F_ARTY_FNCT_executer_mission_tir_par_IA = compile preprocessFile "extern\R3F_ARTY_AND_LOG\R3F_ARTY\piece\executer_mission_tir_par_IA.sqf";
R3F_ARTY_FNCT_suivre_projectile = compile preprocessFile "extern\R3F_ARTY_AND_LOG\R3F_ARTY\piece\suivre_projectile.sqf";
