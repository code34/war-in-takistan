...
class R3F_DEBUG
{
	...
	class Display
	{
		class ShowAllPanels
		{
			...
			file = "R3F_DEBUG\Scripts\FNC_IF_ShowAllPanels.sqf";
		};
		class HideAllPanels
		{
			description = "[EN]\nHide the two main panels\n\n[FR]\nFermer les deux panneaux principaux";
			file = "R3F_DEBUG\Scripts\FNC_IF_HideAllPanels.sqf";
		};
		class ShowMainPanel
		{
			description = "[EN]\nShow the main panel\n\n[FR]\nMontrer le panneau principal";
			file = "R3F_DEBUG\Scripts\FNC_IF_ShowMainDlg.sqf";
		};
		class HideMainPanel
		{
			description = "[EN]\nHide the main panel\n\n[FR]\nFermer le panneau principal";
			file = "R3F_DEBUG\Scripts\FNC_IF_HideMainDlg.sqf";
		};
		class ShowSpyPanel
		{
			description = "[EN]\nShow the variables spy panel\n\n[FR]\nAfficher l'espion des variables";
			file = "R3F_DEBUG\Scripts\FNC_IF_ShowWatcher.sqf";
		};
		class HideSpyPanel
		{
			description = "[EN]\nHide the variables spy panel\n\n[FR]\nFermer l'espion des variables";
			file = "R3F_DEBUG\Scripts\FNC_IF_HideWatcher.sqf";
		};
	};
	class Scripting
	{
